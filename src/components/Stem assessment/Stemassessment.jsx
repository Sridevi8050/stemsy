...
//             <Link to="/stemassessment1"><button className="rounded-sm mt-2 px-2 py-1 text-[#3066BE] border border-[#3066BE] shadow-[#3066BE] hover:bg-[#3066BE] hover:text-white">Saved Challenges </button></Link>
//         </div>
//         </div>
...
//          <h1 className="text-4xl text-white h-30 w-110"><span className="text-[#FFCD5D] ">Invent </span>an automated tool
//          <span className="text-[#FFCD5D] "> to </span> grow food indoors</h1>
//           </div>
//           <div className="space-x-5 relative left-10 top-7">
