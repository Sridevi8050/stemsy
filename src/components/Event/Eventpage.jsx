...
//       {/* Event Banner */}
//       <div
//         className="mt-10 ml-28 rounded-lg p-7 text-white space-y-3 bg-cover bg-center w-[70%] h-[200px]"
...
//           A thrilling STEM event and explore the future of science and
//           technology!
//         </h1>
...
//        <Link to="/event1"> <div className="flex gap-4 space-x-20 pt-4">
...
//         <Link to="/event1"><div className="flex gap-4 space-x-20">
//           {events.map((event, index) => (
//             <Eventitem key={index} {...event} />
//           ))}
//         </div></Link>
