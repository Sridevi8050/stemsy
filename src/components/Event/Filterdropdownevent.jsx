...
//         className="flex items-center ml-[0px] gap-2 px-4 py-2 text-blue-600 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 focus:outline-none"
//       >
//         <span>Filter</span>
...
//                 <li className="px-4 py-2 text-gray-700 cursor-pointer hover:bg-gray-100">{category}</li>
//               </button>
//             ))}
//           </ul>
//         </div>
