...
import Aiimg5 from "../../assets/aiimg5.png"
import Aiimg6 from "../../assets/aiimg6.png"
function Ai2() {
  return (
    <div className="min-h-screen">
      ...
      <div >
        <div className="">
          <img src={Ellipse} className="text-[#5250B540] h-[170px] w-full mt-[-15px]"/>
          ...
          alt="AI Chatbot"
        />
        <span className="font-bold text-2xl md:text-3xl">Storytelling</span>
        </div>
        <br></br>
      ...
      <div className="flex flex-row justify-center items-center space-x-10 mt-10 p-4">
        ...
        <div className="flex items-center space-x-3 w-full max-w-md">
          <input
            className="px-4 py-2 w-full border rounded-md bg-[#5250B50D] outline-none"
